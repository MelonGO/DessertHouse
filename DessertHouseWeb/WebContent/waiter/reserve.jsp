        ...
        <div class="col-md-12">
            ...
            <table class="table waiter-list">
                ...
                <tr>
                    ...
                    <td><jsp:getProperty name="order" property="ordertime"/>
                    	 <button class='btn btn-primary center-block pull-right' 
                        		onclick='click_pay(<jsp:getProperty name="order" property="orderid"/>)'>支付</button>
                    </td>
                </tr>
                <%
                	}
...
<script>
    ...
    function click_pay(ID){
    	var postUrl = "<%=request.getContextPath() + "/ReserveManage"%>";
        var postData2 = ID;
        var ExportForm = document.createElement("FORM");
        document.body.appendChild(ExportForm);
        ExportForm.method = "POST";
        var newElement2 = document.createElement("input"); 
        newElement2.setAttribute("name", "orderid"); 
